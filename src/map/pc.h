...
struct map_session_data {
	...
	struct { //skillatk raises bonus dmg% of skills, skillheal increases heal%, skillblown increases bonus blewcount for some skills.
		unsigned short id;
		short val;
		short casttype; //cast type 0=castrate 1=fixed castrate 2=variable castrate 3=variable cast
...
#define pc_ismado(sd)			( (sd)->sc.option&OPTION_MADO )
...
int pc_setmado(struct map_session_data* sd, int flag);
